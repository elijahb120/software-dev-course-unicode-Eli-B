...
let swappedString = String.fromCharCode(launch[5])+ String.fromCharCode(launch[4])+ String.fromCharCode(launch[3])
+String.fromCharCode(launch[2])+String.fromCharCode(launch[1])+String.fromCharCode(launch[0]) ;
